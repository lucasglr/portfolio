            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 p-2 ">
                    <div class="bg-white">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p>MySQL/MariaDB, MS SQL Server.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 p-2">
                    <div class="bg-white ">
                        <div class="row">
                            <div class="col-12">
                                <i class="fas fa-window-restore"></i></i>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p>GIT, GitHub, Visual Code , Sublime</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 p-2">
                    <div class="bg-white ">
                        <div class="row">
                            <div class="col-12">
                                <i class="fas fa-drafting-compass"></i></i>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <h3>SOFTWARE DE DISEÑO</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                ...
                <div class="col-12 col-sm-6 p-2">
                    <div class="bg-white">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p>Excel,Word,Power Point, Ms Project .
                                </p>
                            </div>
                        </div>
                    </div>
